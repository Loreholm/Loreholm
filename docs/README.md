...
| [Loreholm architecture](01_Architecture.md) | Implemented capture, mining, graph commit, and compensating knowledge maintenance |
...
| [Mining and knowledge](07_MiningAndKnowledge.md) | Implemented admission, extraction, identity, evidence-backed commit, re-mining, and schema maintenance with planned surfacing |
...
exist today. Grounded query/surfacing remains design work.
